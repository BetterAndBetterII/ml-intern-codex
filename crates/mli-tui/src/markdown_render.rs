...
///
/// Local file links are rendered relative to the current process working directory.
...
/// Like [`render_markdown_text_with_width`], but accepts an explicit working directory for local
/// file links.
///
